...
def add_CartServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('oteldemo.CartService', rpc_method_handlers)
...
def add_RecommendationServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('oteldemo.RecommendationService', rpc_method_handlers)
...
def add_ProductCatalogServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('oteldemo.ProductCatalogService', rpc_method_handlers)
...
def add_ShippingServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('oteldemo.ShippingService', rpc_method_handlers)
...
def add_CurrencyServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('oteldemo.CurrencyService', rpc_method_handlers)
...
def add_PaymentServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('oteldemo.PaymentService', rpc_method_handlers)
...
def add_EmailServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('oteldemo.EmailService', rpc_method_handlers)
...
def add_AdServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('oteldemo.AdService', rpc_method_handlers)
...
def add_FeatureFlagServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('oteldemo.FeatureFlagService', rpc_method_handlers)
